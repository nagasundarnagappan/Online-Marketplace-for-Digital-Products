            ...
            <section className="text-gray-700 body-font overflow-hidden bg-white">
                <div className="container px-5 py-16 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="product" className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={details.fileLocation} />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            <h2 className="text-sm title-font text-gray-500 tracking-widest">PRODUCT TYPE : {(details.category === 'img') ? "Image" : "Document"}</h2>
                            <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">{details.productName}</h1>
                            ...
                            <p className="leading-relaxed pb-5">{details.productDescription}</p>
                            ...
                            <div className="flex pt-5 border-t-2 border-gray-200">
                                <span className="title-font font-medium text-2xl text-gray-900">₹ {details.productPrice}</span>
                                <button onClick={addToCart} className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">
                                    <img alt="cart" src="../assets/img/cart.png" className="h-6 mr-2" />
                                    Add to Cart
                                </button>
